...
//    @RequestMapping("/search")
//    @ResponseBody
//    public ForumResult searchByKeywords1(@RequestParam("keywords") String keywords) throws UnsupportedEncodingException {
//        ForumResult forumResult = new ForumResult();
//        String keywordsCon=new String(keywords.getBytes("iso8859-1"), StandardCharsets.UTF_8);
//        List<Question> questions = searchService.searchByTitleAndContent(keywordsCon);
//        List<UserIndexQuestionVO> res = new ArrayList<>();
//
//        if (questions.size() != 0) {
//            for (Question q : questions) {
...
//        } else {
//            forumResult.setData(202);
//            forumResult.setMsg("没有查到相关信息");
//        }
//        return forumResult;
//    }
    /**
